...
## 1. Scope
 ...
 a) These terms of use set forth legally binding terms and conditions governing your use of the website, Rareburg.com, which is provided by Rareburg LTD (Rareburg). By using or browsing the site you agree to be bound by this agreement.
...
## 2.Definitions
 ...
 d) 'Item' refers to an item owned by a Rareburg user. Users are able to upload image representations of their item, and text descriptions.

 e) 'Buyer' refers to a Rareburg user who attempts to buy an item from another Rareburg user, referred to as a 'seller'.

 f) 'Sale agreement' describes the binding agreement between a buyer and seller to buy and sell an item, respectively.

 g) 'Trust Points' refer to a system operated by Rareburg to score a users' history on the site.
 ...
 i) 'Trade block' refers to a block that Rareburg places on items which are in the process of an active trade.
 ...
 l) 'Final sale amount' refers to the total amount paid for an item. It is inclusive of Rareburg's fee and all applicable sales taxes.
...
a) Rareburg is a marketplace for collectors, allowing users to list and buy and sell items between each other.

b) You agree that Rareburg has no control over the accuracy, safety or legality of items listed by users.

c) Rareburg reserves the right, at its sole discretion, to refuse access to the service to any user at any time, temporarily or permanently.
...
a) If you are using the service as a business entity, you are agree that you will indicate this where given the opportunity to do so within the website. If you are VAT registered, you are obliged to provide your VAT number where encouraged to do so. If you are in any doubt as to whether you should register as a business or upload a VAT number, you should contact Rareburg customer support via the account menu.
...
i) The item belongs to you and you are authorised to grant Rareburg rights contained in this agreement in relation to the item.
...
iv) No licence is required from any third party in order for Rareburg to make use of the item details. In addition that Rareburg's use of the item details does not infringe on any third party's intellectual property rights.
...
e) As part of a transaction within the service, you may obtain the name and address details of other users. This information should only be used to complete the transaction. Rareburg does not grant you any licence to use that information to send any commercial or unsolicited messages or for any purpose beyond completing the transaction.

f) You guarantee not to manipulate the site's Trust Points system in a misleading or fraudulent manner.

g) You guarantee that you will not attempt to avoid site fees by conducting trades with other Rareburg users outside of the Rareburg service.

## 8. Communication Between Users

a) Rareburg allows for users to comment publicly on items and also to send private messages to each other. Rareburg takes no responsibility for the content of comments or messages, but will endeavour to take action if any user reports any content found to be offensive.

## 9. Liability

a) You agree that your use of the service is at your own risk and that Rareburg offers no warranty in relation to your usage nor any losses or damage that could ensue from your usage of the service. If you use the service for commercial purposes, you agree to indemnify Rareburg and its Directors from and against any disputes, losses, legal proceedings, damages, accounting fees that could arise.

b) You agree that you will not hold us responsible for any action or inaction by a buyer or seller, and you understand that Rareburg is not responsible for completing any trade. The sale agreement us between the buyer and seller user.

## 10. Indemnification

a) You agree that you indemnify Rareburg and its directors and employees from any claim, and any legal fees arising from any claim, made by any third party due to your breach of this agreement.

## 11. Your Content

a) You retain intellectual property of all content you upload to the site.

b) You grant Rareburg and its users a non-exclusive, royalty-free, transferable, sub-licensable, worldwide license to store and use any content you upload while using the service. This includes, but is not limited to item details as well as comments.

c) Rareburg reserves the right to, without giving notice or reason, remove content that you have uploaded.

## 12. Intellectual Property

a) The intellectual property rights in respect of the service, website and database contents resides with Rareburg. This includes, but is not limited to, all text, image, video content, logos, but does not relate to user-submitted material.
...
c) You agree that when uploading a Buy Now item, the price that you set is to be the final sale amount. This is the total that will be collected from the buyer and is inclusive of UK shipping costs that you may incur to fulfill delivery of the item to a UK buyer. It also includes Rareburg's fee and a small fee from Paypal for processing the transaction. The net sale proceeds you receive will have had these fees deducted. See section 19. on fees below for more information on applicable fees.

d) You warrant that you understand that in order to receive payment for any item that you agree to sell, you will need a valid PayPal email address. Rareburg will assume that the email address that you registered with is also your PayPal email address and will attempt to make payment to it following a successful trade. You should notify Rareburg customer support before or immediately after accepting an offer should you need to arrange for payments to be made to an alternative email address.
...
- Sexually explicit material. Where this relates to artistic works, Rareburg reserves the right to decide on whether the item falls into this category.
...
g) Should a buyer or seller refuse to honour a sale agreement, any ensuing dispute is between buyer and seller, and does not involve Rareburg. However, Rareburg will attempt to mediate and may ultimately cancel the trade status within the website to reflect the status of the trade. Reneging on the agreed sale of an item may lead to a reduction in a seller's Trust Points.
...
i) Upon acceptance of an offer, a payment expiry is also set, indicating a date by which payment must have been made to the seller. Failure to pay by this deadline is a breach of the sale agreement between you and the seller. It may also cause your Rareburg account to be suspended or your Trust Points to be deducted. 
...
b) Rareburg reserves the right to require the buyer to provide proof of ID and a signed declaration before payment is allowed on larger transactions. Where Rareburg requests such documents and they are not forthcoming, you agree that Rareburg may cancel the trade, in which case, the sales agreement will be cancelled.

c) If the seller's email address is determined to be ineligible to receive funds at the point the buyer attempts to make payment, Rareburg will attempt to resolve but reserve the right to cancel the payment. If Rareburg are unable to resolve the issue, the trade will be cancelled.
...
d) Sellers are encouraged to upload the shipping tracking code for their arranged delivery to the Trade within the website so that Rareburg can report on the successful delivery automatically.

e) If no delivery is confirmed before the delivery deadline from an uploaded tracking code or from the buyer indicating so, the buyer should contact both Rareburg and the seller. Rareburg will attempt to mediate, and failing that, the buyer is advised to contact Paypal under their Buyer Protection policy. 

f) In the event that buyer and seller agree that delivery should take place in person without third party tracking used, the seller should be aware that Rareburg may have no way of ascertaining that delivery happened. Users should also be aware that Paypal's Buyer/Seller Protection does not apply for collections.


## 18. Disputes

a) Rareburg will attempt to mediate any dispute between users.
...
a) Rareburg retains a commission on successful payments, amounting to up to 12% of the transaction value. 

b) Paypal also charges a fee for processing the transaction. Information can be found [here](https://www.paypal.com/uk/uk/webapps/mpp/paypal-fees/).

c) Both the Rareburg commission and the Paypal fee are deducted from the final sale amount that the buyer pays. The final amount that the seller receives, the Net Sales Proceeds, is net of all fees. This amount is displayed to the seller before they accept an offer, or at the point they list an item as 'Buy Now'.

d) Rareburg's commission fee is non-refundable unless otherwise stated.
...
b) It is the seller's responsibility to inform Rareburg customer care at the point that an offer is accepted if they require a PayPal email address to be stored which is different to the one they registered for the service with.

## 22. Trust Points

a) Trust Points are a trust scoring system operated by Rareburg. They indicate a trust score of each user based on factors related to a user's history in using the site. Rareburg reserves the right to increase and decrease Trust Points at its sole discretion.

## 23. Account Statement

a) An account statement listing your previous trades and payments is available at request from Rareburg customer care.

## 24. Item Ownership

a) Following a successful trade, the ownership of an item within the service will be transferred from seller to buyer.

b) Rareburg may, at its sole discretion, allow for items to be transferred between users where no trade has been conducted on the site, where both users request such.
...
a) Rareburg reserves the right to alter these terms at any time and will communicate such changes electronically to you.

b) This agreement may not be assigned by you, but may be assigned by Rareburg without restriction.
...
d) No waiver of a term shall constitute an on-going waiver of that or any other terms. Rareburg's failure to assert any right under this agreement will not constitute a waiver of such a right or the entire agreement.
